...
const EdgeTabs = () => {
  return (
    <Tab.Navigator initialRouteName="extraTab" tabBar={props => <MenuTabs {...props} />} screenOptions={{ headerShown: false }} >
...
const RequestTabScreen = () => {
  return (
    <Stack.Navigator initialRouteName="extraTab2" screenOptions={defaultScreenOptions}>
      <Stack.Screen name="extraTab2" component={RequestScene} options={firstSceneScreenOptions} />
    </Stack.Navigator>
  )
}
